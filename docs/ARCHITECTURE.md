...
本文描述 0.3.1-alpha.1 当前代码，未来设计见[演进路线](DIGITAL_HUMAN_ROADMAP.md)。验收入口见[整体验收流程](MANUAL_TEST_PLAN.md)。
...
1. 桌面发送带令牌的命令；服务校验并接受输入。接受命令不代表模型已完成回答。
