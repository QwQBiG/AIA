...
本轮交付点为 [0.2.0-alpha.1 数字伙伴工作室 Alpha](releases/0.2.0-alpha.1.md)：收束角色收藏、身份记忆、多种原生外形、可携带场景、启动恢复和原生逐句表达。推送 GitHub 后按用户要求停止本轮开发；恢复任务后再选择下面的后续里程碑。这个阶段版本不代表 M0–M5 的完整验收故事已经全部完成。
