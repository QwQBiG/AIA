...
当前已落地图片外形这一种资源包；角色、声音、行为与场景还没有统一包管理和组合编辑，独立网页/VRM 载体尚未实现。角色间记忆已隔离，仍需补交互对象隔离、记忆来源、纠正和关系连续性。
...
身份与记忆切换已实现：活动回合拒绝切换，空闲时切换会停止剩余音频、清空短期上下文并选择持久记忆范围。当前可通过已有角色面板操作，角色列表、包保存、场景切换及版本冲突检查仍待实施。
